...
│    у вас вдома. Введіть статичну IP-адресу │
│    вашого роутера — коли світло зникає,    │
│    роутер вимикається і стає недоступним.  │
│                                             │
│    ⚠️ Важливо: Потрібна статична IP-адреса,│
│    яка не змінюється при перезавантаженні  │
│    роутера. Цю послугу можна замовити у    │
│    вашого інтернет-провайдера (приблизно   │
│    30-50 грн/місяць).                       │
│                                             │
